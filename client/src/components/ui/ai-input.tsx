...
export function MorphPanel({ onSubmitMessage }: MorphPanelProps = {}) {
    ...
    <div className="flex items-center justify-center" style={{ width: FORM_WIDTH, height: FORM_HEIGHT }}>
      ...
      >
        <FormContext.Provider value={ctx}>
          <DockBar />
          <InputForm ref={textareaRef} onSuccess={handleSuccess} onSubmitMessage={onSubmitMessage} />
...
>(function InputForm({ onSuccess, onSubmitMessage }, ref) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault()
    const value = localTextareaRef.current?.value?.trim() ?? ""
    if (value && onSubmitMessage) {
      onSubmitMessage(value)
      if (localTextareaRef.current) localTextareaRef.current.value = ""
    }
    onSuccess()
  }
        ...
        {showForm && (
          ...
          >
            ...
            <textarea
              ...
              spellCheck={false}
              data-testid="input-ask-ai-textarea"
            />
          </motion.div>
        )}
      </AnimatePresence>
