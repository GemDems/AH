...
export function AnimatedGlowingSearchBar({
  ...
  const showTypewriter = !!animatedPhrases?.length && !isFocused && value === "";
  const typedText = useTypewriter(animatedPhrases ?? [], showTypewriter);

  return (
    <div className="relative flex items-center justify-center">
      <div id="poda" className="relative flex items-center justify-center group h-[70px]">
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[314px] rounded-xl blur-[3px]
                        ...
                        before:bg-[conic-gradient(#0d0f1a,#402fb5_5%,#0d0f1a_38%,#0d0f1a_50%,#cf30aa_60%,#0d0f1a_87%)]
                        before:[transition:transform_2000ms_cubic-bezier(0.4,0,0.2,1)]
                        group-hover:before:rotate-[-120deg]
                        group-focus-within:before:rotate-[420deg] group-focus-within:before:[transition-duration:4000ms]">
        </div>
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[312px] rounded-xl blur-[3px]
                        ...
                        group-focus-within:before:rotate-[442deg] group-focus-within:before:[transition-duration:4000ms]">
        </div>
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[307px] rounded-lg blur-[2px]
                        ...
                        group-focus-within:before:rotate-[443deg] group-focus-within:before:[transition-duration:4000ms]">
        </div>
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[303px] rounded-xl blur-[0.5px]
                        ...
                        before:bg-[conic-gradient(#0d0f1a,#402fb5_5%,#0d0f1a_14%,#0d0f1a_50%,#cf30aa_60%,#0d0f1a_64%)] before:brightness-130
                        before:[transition:transform_2000ms_cubic-bezier(0.4,0,0.2,1)]
                        group-hover:before:rotate-[-110deg]
                        group-focus-within:before:rotate-[430deg] group-focus-within:before:[transition-duration:4000ms]">
        </div>
        ...
        <div id="main" className="relative group">
          ...
          />
          {showTypewriter && (
            <div className="pointer-events-none absolute left-[59px] top-0 h-[56px] flex items-center text-lg text-gray-400">
              <span>{typedText}</span>
              <span className="ml-[2px] inline-block w-[2px] h-[1.1em] bg-gray-400 animate-pulse"></span>
            </div>
          )}
