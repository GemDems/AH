    ...
    <header style={{ background: "#0d0f1a" }} className="w-full">
      ...
      <div className="relative text-center pt-10 pb-2 px-4">
        <div className="mb-3 flex justify-center">
          <LiquidBadge className="sm:w-44 w-24">
            <span className="tracking-[0.14em] whitespace-nowrap font-black border-t-[0px] border-r-[0px] border-b-[0px] border-l-[0px] text-[8px]" style={{ WebkitTextStroke: "0.5px currentColor" }}>
